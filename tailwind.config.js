...
module.exports = {
  ...
  theme: {
    extend: {
      spacing: {
        sidebarPadding: 'var(--sidebarWidthPadding)',
        sidebarOpen: 'var(--widthAndPosition)',
      }
    },
    accentColor: ({ theme }) => ({
      ...theme('colors'),
    ...
    boxShadow: {
      ...
      none: 'none',
      dropdown: '0 0 20px 1px rgba(0,0,0,0.15)',
      tooltip: '0 0 6px 0 rgba(0,0,0,0.15)',
      card: '0 0 20px 0 rgba(0,0,0,0.10)'
    },
    ...
    colors: ({ colors }) => ({
      ...
      themeGrayscale800: "#1f2937",
      themeGrayscale700: "#313a49",
      themeGrayscale600: "#687588",
      themeGrayscale500: "#a0aec0",
      themeGrayscale400: "#cbd5e0",
      themeGrayscale300: "#e9eaec",
      themeGrayscale200: "#f1f2f4",
      themeGrayscale100: "#f8f8f8",
      themeGrayscale50: "#fafafa",
      ...
      themeWarning: '#facc15',
      themeWarningDark: '#e6bb20',

      themeDangerLight: '#ffedec',
      themeDanger: '#e03137',
    ...
    fontSize: {
      ...
      bsm: ['0.75rem', { lineHeight: '1.25rem' }],
      bmd: ['0.875rem', { lineHeight: '1.25rem' }],
      blg: ['1.125rem', { lineHeight: '1.75rem' }],
      ...
      'h5': ['var(--h5)', { lineHeight: '1.25' }],
      'h6': ['var(--h6)', { lineHeight: '1.25' }],
    },
    fontWeight: {
      thin: '100',
      extralight: '200',
    ...
    width: ({ theme }) => ({
      ...
      fit: 'fit-content',
      dropDown: '400px',
      sidebar: 'var(--sidebarWidthPadding)',
      sidebarOpen: 'var(--widthAndPosition)',
    }),
    willChange: {
      auto: 'auto',
