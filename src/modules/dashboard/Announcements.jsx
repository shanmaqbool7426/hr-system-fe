                        ...
                        <div className="flex flex-col gap-2">
                            {["New Branch Opening", "AI Trend In Tech Industry", "Chat Bot Luch", "Fuel Allowance", "Medical Facility"].map((ele, i) => (
                                <div key={i} className="bg-themeGrayscale50 rounded p-3 flex justify-between">
                                    ...
                                    <span className="text-themePurple bg-themePurple/10 rounded-md px-2 py-1 text-xs font-medium">View</span>
                                </div>
                            ))}
                        </div>
                    </Tab.Panel>
                    <Tab.Panel className={'zt-themeTabPanel'}>
                        <div className="flex flex-col gap-2">
                            {["New Branch Opening", "AI Trend In Tech Industry", "Chat Bot Luch", "Fuel Allowance", "Medical Facility"].map((ele, i) => (
                                <div key={i} className="bg-themeGrayscale50 rounded p-3 flex justify-between">
                                    <h3 className="text-xs mb-0 font-semibold">{ele}</h3>
                                    <span className="text-themePurple bg-themePurple/View rounded-md px-2 py-1 text-xs font-medium">10</span>
                                </div>
                            ))}
                        </div>
                    </Tab.Panel>
