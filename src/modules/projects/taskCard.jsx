            ...
            <div className='flex flex-col gap-4 p-6 border rounded-2xl'>
                <div className='bg-white rounded-lg p-3 flex flex-col gap-4'>
                    <div className={`flex justify-between`}>
                        ...
                        {check_rights(auth_user) && <DropDown icon={<ThreeDotsVertical className={'text-gray-500'} width={'1.5rem'} />}>
                            <ul className="zt-themeDropDownList zt-sm gap-4">
                                <li className="!p-0">
                                    <a onClick={() => {
                    ...
                    <div className='flex justify-between'>
                        <div>
                            <span className='font-semibold text-sm mb-1'>Due Date</span>
                        ...
                        <div className='flex flex-col items-center'>
                            <span className='font-semibold text-sm mb-1'>Status</span>
