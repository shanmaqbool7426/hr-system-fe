...
export const Staticts = () => {
    ...
    return (
        <div className='flex flex-col xl:flex-row gap-6'>
            <div className='zt-card w-full flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-4 justify-between grow'>
                    <div className='rounded-lg p-4 bg-themeGrayscale50 dark:bg-gray-700 flex justify-between'>
                        <div className='flex flex-col justify-between text-sm'>
                            <span className='text-themeGrayscale600 dark:text-white'>{t("Work Time")}</span>
                    ...
                    <div className='self-end w-full flex justify-between gap-3 text-sm'>
                        <div className='bg-themeGrayscale50 dark:bg-gray-700 rounded-lg p-3 flex flex-col gap-1 items-center'>
                    ...
                    <Tab.Panels className={`zt-themeTabPanels zt-employeeTabsPanel !bg-transparent !p-0`}>
                        <Tab.Panel className={'zt-themeTabPanel'}>
                            {["Attendance Policy", "Leave Policy", "Remote Work Policy"].map((ele, i) => (
                                <div key={i} className='flex justify-between items-center p-3 bg-themeGrayscale50 dark:bg-gray-700 rounded-lg mb-2'>
