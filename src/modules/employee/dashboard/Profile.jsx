...
export const Profile = () => {
    ...
    return (
        <div className='rounded-lg py-12 px-8 flex gap-4 flex-col md:flex-row justify-between items-center bg-darkestPurple bg-cover' style={{ backgroundImage: `url(/assets/images/asset/employee-bg.png)` }}>
            <div className='text-white'>
                <h2 className='text-xl font-bold mb-2 text-white'>{t("Employee of the month")}</h2>
                <p className='mb-8 text-sm w-4/5'>{t("We are really proud of the difference you have made which gives everybody the reason to applaud & appreciate")}</p>
