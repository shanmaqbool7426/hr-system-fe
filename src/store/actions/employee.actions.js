...
import { setLoading, setEmployeesList,setEmployeeDetails, setEmployee, pushEmployee, removeEmployee } from '../slices/employee.slice'
...
export const CreateEmployee = (payload, onSuccess = null) => async (dispatch) => {
    try {
        dispatch(setLoading(true))
...
export const UpdateEmployee = (id, payload, onSuccess = null) => async (dispatch) => {
    try {
        dispatch(setLoading(true))
