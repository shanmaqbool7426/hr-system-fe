...
export default function Sidebar() {
  ...
  const Navigation = {
    ...
    attendance: [
      ...
      { name: t("Attendance Approval"), href: "/attendance/approvels" },
      {
    ...
    report: [
      {
        ...
        innerSubMenu: [
          {
            name: t("Employee Change History"),
            href: "/report/hr-reports/employee-change-history",
          },
          {
            name: t("Hiring Details"),
            href: "/report/hr-reports/hiring-details",
          },
          {
            name: t("Separation Details"),
            href: "/report/hr-reports/separation-details",
          },
          {
            name: t("Employee Role Report"),
            href: "/report/hr-reports/employee-role-report",
          },
          {
            name: t("Employee List"),
            href: "/report/hr-reports/employee-list",
          },
          {
            name: t("Employee Profile"),
            href: "/report/hr-reports/employee-profile",
          },
          {
            name: t("Employee Dependent"),
            href: "/report/hr-reports/employee-dependent",
          },
          {
            name: t("Department Head Count"),
            href: "/report/hr-reports/department-head-count",
          },
          {
            name: t("Employee Clearance"),
            href: "/report/hr-reports/employee-clearance",
          },
          {
            name: t("Employee Documents"),
            href: "/report/hr-reports/employee-documents",
          },
        ],
      },
      ...
      {
        name: t("Attendance Restriction"),
        href: "/report/attendance-restriction",
      },
    ],
    organization: [
            ...
            {MiniBar.map((item, index) => (
              <li key={index} className={`px-5 py-3`}>
                {item?.page ? (
                  ...
                  >
                    <span
                      className={`zt-menuIcon text-themePrimary/45 hover:text-themePrimary ${
                        router.asPath === item.href && "!text-themePurple"
                      }`}
                    >
                      <item.icon />
                    </span>
                  ...
                  >
                    <span
                      className={`zt-menuIcon text-themePrimary/45 hover:text-themePrimary ${
                        router.asPath.includes(item.href) && "!text-themePurple"
                      }`}
                    >
                      <item.icon />
                    </span>
                ...
                <li key={index}>
                  <div className="flex">
                    {item?.innerSubMenu ? (
                      ...
                      <Link
                        className={`zt-sidebar-link ${
                          router.asPath === item.href ? "zt-active" : ""
                        }`}
                        href={item.href}
                      >
                        {item.name}
                        ...
                        <li className="relative py-1" key={index2}>
                          <div
                            className={`absolute left-0  ${
                              index2 === 0 ? "h-1/2 top-0.5" : "h-full -top-4"
