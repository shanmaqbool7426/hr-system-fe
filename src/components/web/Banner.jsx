      ...
      <div className='container'>
        <div className='grid md:grid-cols-2 items-center'>
          <div className='zt-bannerContent pr-[9%]'>
            ...
            <p>Discover the future of HR management at Zaffre Tech, where efficiency meets empowerment. Join us in revolutionizing how you nurture your workforce, freeing up valuable time for growth and innovation.</p>
