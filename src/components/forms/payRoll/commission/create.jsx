...
export default function CommissionForm({ onClose, object, }) {
    ...
    return (
        <BaseForm title={object ? "Edit Commission" : "Apply For Commission"} formElements={formElements} formik={formik} onClose={onClose} is_loading={is_loading}>
        </BaseForm>
    )
}