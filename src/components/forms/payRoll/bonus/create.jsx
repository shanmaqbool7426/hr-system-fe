...
export default function BonusForm({ onClose, object, }) {
    ...
    const formElements = [
        ...
        },
        {
            ...
            name: "bouasType",
            label: t("Bonus Type"),
            value: formik.values.bouasType,
            required: true,
            list: [
                { value: "Leaves", display: "Leaves" }, 
            ]
        },
        {
            type: "text",
        ...
        },      
        {
            ...
            label: t("Adjustment Method"),
            value: formik.values.adjustmentMethod,
            required: true,
            list: [
    ...
    return (
        <BaseForm title={object ? "Apply For Bonus" : "Apply For Bonus"} formElements={formElements} formik={formik} onClose={onClose} is_loading={is_loading}>
        </BaseForm>
    )
}