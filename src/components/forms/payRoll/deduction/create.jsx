...
export default function DeductionForm({ onClose, object, }) {
    ...
    const formElements = [
        ...
        },
        {
            type: "select",
            name: "dedicationType",
            label: t("Dedication Type"),
            value: formik.values.dedicationType,
            required: true,
            list: [
    ...
    return (
        <BaseForm title={object ? "Apply For Deduction" : "Apply For Deduction"} formElements={formElements} formik={formik} onClose={onClose} is_loading={is_loading}>
        </BaseForm>
    )
}