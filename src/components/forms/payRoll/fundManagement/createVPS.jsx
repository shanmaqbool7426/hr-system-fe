...
export default function VPSForm({ onClose, object, }) {
    ...
    const formElements = [
        ...
        {
            type: "select",
            name: "dedicationMethod",
            label: t('Dedication Method'),
            placeholder: t("PF Loan"),
            required: true,
            value: formik.values.dedicationMethod,
            list: [
        ...
        },
        {
            ...
            label: t('VPS'), 
            required: true,
            value: formik.values.vps,
            list: [
                { value: "Lower Volatility", display: "Lower Volatility" },
                { value: "Life Cycle Allocation", display: "Life Cycle Allocation" },
            ]
        },
        {
            type: "text",
    ...
    return (
        <BaseForm title={"Add Voluntary Pension Scheme"} formElements={formElements} formik={formik} onClose={onClose} is_loading={is_loading} />
    )
}