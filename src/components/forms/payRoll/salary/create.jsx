...
export default function SalaryChangesForm({ onClose, object, }) {
    ...
    const formElements = [
        ...
        },
        {
            ...
            name: "title",
            label: t("Title"),
            placeholder: t("Annual Increment"),
        ...
        }, 
        {
            ...
            required: true,
            list: [
                { value: "Increment Amount", display: "Increment Amount" }, 
            ]
        },
        {
            type: "text",
            ...
            placeholder: t("$200"),
            value: formik.values.incrementAmount,
            required: true, 
        },
        {
            type: "textarea",
    ...
    return (
        <BaseForm title={"Apply For Salary Charges"} formElements={formElements} formik={formik} onClose={onClose} is_loading={is_loading}>
        </BaseForm>
    )
}