...
export default function PFWithdrawForm({ onClose, object, }) {
    ...
    return (
        <BaseForm title={"Apply For PF Withdrawal"} formElements={formElements} formik={formik} onClose={onClose} is_loading={is_loading}>
        </BaseForm>
    )
}