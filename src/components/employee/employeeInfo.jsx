      ...
      : <>
        <div className='px-4 border-r border-dashed border-themeGrayscale600'>
          ...
          <div className='flex flex-col'>
            ...
            <p className='mb-0 gap-4'>
              ...
              <strong>{t(employee?.employeeCode)}</strong>
            </p>
            <p className='gap-4'>
              <span>{t('Joining Date')}</span>
              <time dateTime={t(employee?.joiningDate)}>{t(employee?.joiningDate)}</time>
            </p>
            <p className='mb-0'><span className='zt-tag zt-tag-purple'>{t(employee?.employmentStatus)}</span></p>
          </div>
        </div>
        ...
        <div className='px-4 border-l border-dashed border-themeGrayscale600'>
          <ul>
            <li>
              <span>Email</span>
              <a className='text-sm text-themePurple' href='mailto:lincoln@gmail.com'>{t(employee?.email)}</a>
            </li>
            <li>
