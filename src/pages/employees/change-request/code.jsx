...
import ChangeCodeForm from '@/components/forms/employees/change-request/code';
...
export default function EmployeeCodePage() {
	...
	const headings = [
		...
		{ title: t("Current Employee Code"), col: "currentValue" },
		{ title: t("New Employee Code"), col: "employeeCode", },
