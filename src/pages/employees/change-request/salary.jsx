...
import ChangeSalaryForm from '@/components/forms/employees/change-request/salary';
...
export default function ChangeSalaryPage() {
	...
	const headings = [
		...
		{ title: t("Current Salary"), col: "currentValue" },
		{ title: t("New Salary"), col: "salary", },
	...
	return (
		<section className="flex flex-col grow">
			...
			{change &&
				<ChangeSalaryForm onClose={() => setChange(false)} />
			}
		</section>
	)
}
