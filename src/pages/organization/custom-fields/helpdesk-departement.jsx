...
export default function HelpDeskDepartementPage() {
    ...
    return (
        <>
            <div className="flex justify-between items-center pb-6">
                <div className="">
                    <h1 className="text-h4 mb-0">{t("Helpdesk Departement")}</h1>
                    <p className="mb-0">{t("Manage your Helpdesk Departement")}</p>
                </div>
                <div className="flex items-start gap-2">
                    <Button className={"btn btn-primary"} onClick={() => setCreate(true)}>{t("Create Helpdesk Departement")}</Button>
                </div>
            </div>
