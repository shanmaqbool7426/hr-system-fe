...
export default function VendorRatingValuesPage() {
    ...
    return (
        <>
            <div className="flex justify-between items-center pb-6">
                <div className="">
                    <h1 className="text-h4 mb-0">{t("Vendor Rating Values")}</h1>
                    <p className="mb-0">{t("Manage your Vendor Rating Values")}</p>
                </div>
                <div className="flex items-start gap-2">
                    <Button className={"btn btn-primary"} onClick={() => setCreate(true)}>{t("Create Vendor Rating Values")}</Button>
                </div>
            </div>
