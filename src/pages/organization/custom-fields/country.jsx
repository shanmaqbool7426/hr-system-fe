...
export default function ManageCountryPage() {
  ...
  const rows = customfield_list.filter(item => item.type === 'country')
    .sort((a, b) => {
      if (sortDir === 'asc')
  ...
  return (
    <>
      <div className="flex justify-between items-center pb-6">
        <div className="">
          <h1 className="text-h4 mb-0">{t("Countries")}</h1>
      ...
      <div className=" zt-card grow">
        ...
        <Table
          ...
          page={page}
          setPage={setPage}
          className={'zt-employeeTable zt-countryTable'}
        />
      </div>
      {create && <CreateCustomFieldForm
        title={edit ? t('Country') : t('Country')}
        type={'country'}
