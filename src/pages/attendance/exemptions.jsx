...
export default function Exemptions() {
    ...
    const headings = [
        ...
        { title: t("Flag Type"), col: "flagType", /* sort: true */ },
    ...
    return (
        <section className="flex flex-col grow">
            ...
            <div className="flex justify-between pb-6">
                <h1 className="text-h4 mb-0">{t("Exemption Request")}</h1>
                <Button className={"btn btn-primary"} onClick={() => setCreate(true)}>{t("Add Exemption Request")}</Button>
            </div>
