...
import SalarySetUpForm from "@/components/forms/payRoll/salary/setup";
import FilterArea from "@/components/includes/FilterArea";
import { CrossClose, EyeOn, SuccessTick, ThreeDotsVertical, WarningIcon } from "@/components/svg";
	...
	return (
		<section className="flex flex-col grow">
			...
			<div className="flex justify-between pb-6">
				<div className="flex flex-col">
					<h1 className="text-h4 mb-0">{t("Salary Setup")}</h1>
				</div>
				<div className="flex items-start gap-2">
					<Button onClick={() => { setCreate(true) }} className={"btn btn-primary"}>{t("Apply For Salary Setup")}</Button>
				</div>
			</div>
			...
			{create && <SalarySetUpForm onClose={() => setCreate(false)} />}
