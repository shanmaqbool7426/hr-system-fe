...
export default function OvertimePage() {
	...
	const headings = [
		...
		{ title: t("Hours Details"), col: "HoursDetails", },
	...
	return (
		<section className="flex flex-col grow">
			...
			<div className="flex justify-between pb-6">
				<h1 className="text-h4 mb-0">{t("Overtime Request")}</h1>
				<div className="flex items-start gap-2">
					<Button className={"btn btn-dark-outline"}>{t("Upload Excel")}</Button>
					<Button onClick={() => { setApply(true) }} className={"btn btn-primary"}>{t("Apply For  Overtime")}</Button>
				</div>
			</div>
			...
			{apply && <ApplyOvertimeForm onClose={() => { setApply(false) }} />}
		</section>
	)
}