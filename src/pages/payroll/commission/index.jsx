...
import CommissionForm from "@/components/forms/payRoll/commission/create"; 
	...
	return (
		<section className="flex flex-col grow">
			...
			<div className="flex justify-between pb-6">
				<div className="flex flex-col">
					<h1 className="text-h4 mb-0">{t("Commission")}</h1>
				</div>
				<div className="flex items-start gap-2">
					<Button className={"btn btn-dark-outline"}>{t("Upload Excel")}</Button>
					<Button onClick={() => { setPFWithdraw(true) }} className={"btn btn-primary"}>{t("Apply For Commission")}</Button>
				</div>
			</div>
			...
			{pfWithdraw && <CommissionForm onClose={() => setPFWithdraw(false)} />} 
